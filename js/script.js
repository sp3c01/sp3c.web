 const links = [
    ...
    { name: '@كلمة المرور', url: 'https://www.xvideos.com/video.uaoivmh52bc/rebolei_e_sentei_gostoso_na_rola_do_safado_ele_nao_resistiu_e_gozou_gostoso#show-related' },
    { name: 'كلمة المرور#', url: 'https://www.xvideos.com/video.ududhof226b/mais_uma_vez_nao_resisti_a_bunda_monumental_da_minha_enteada_-_fodendo_de_conchinha#show-related' },
    ...
    { name: 'Todo Mundo em Panico', url: 'http://example.com/divertida-mente-2' },
    { name: 'Todo Mundo em Panico 2', url: 'https://www.mediafire.com/file/orbwujffu5k0q3w/Todo_Mundo_em_P%25C3%25A2nico_2.mp4/file' },
    { name: 'Todo Mundo em Panico 3', url: 'https://www.mediafire.com/file/5uq1pkrjfkm4j6r/Todo_Mundo_em_P%25C3%25A2nico_3.mp4/file' },
    { name: 'Todo Mundo em Panico 4', url: 'http://example.com/divertida-mente-2' },
    { name: 'Todo Mundo em Panico 5', url: 'http://example.com/divertida-mente-2' },
    { name: 'Panico VI', url: 'https://www.mediafire.com/file/oyugn2efnqi0u9y/PNCO6.mp4/file' },
...
function search() {
    ...
    if (uniqueLinks.size > 0) {
        ...
        results.innerHTML = 'здесь ничего';
    }
